export default function StandardServiceCard(props) {
  ...
  return (
    <button className="flex flex-col justify-between items-center w-36 h-56 mt-2 mb-2 border-solid border-neutral-200 border-t border-r border-l border-b-8 border-b-mediumgreen ">
