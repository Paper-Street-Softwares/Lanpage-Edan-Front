export default function StandardServiceCard(props) {
  ...
  return (
    <a className="flex flex-col items-center justify-between h-56 mt-2 mb-2 border-t border-b-8 border-l border-r border-solid w-36 border-neutral-200 border-b-mediumgreen ">
      ...
      <div className="flex flex-col items-center justify-between w-full h-full font-poppins">
        <div className="flex flex-col justify-end p-1 h-1/3">
