export default function StandardServiceCard(props) {
  ...
  return (
    <a className="flex flex-col items-center justify-between w-full h-56 mt-2 mb-2 border-t border-b-8 border-l border-r border-solid border-neutral-200 border-b-secondary tablet2:w-28 desktop1:w-36">
      ...
      <div className="flex flex-col items-center justify-between w-full h-full font-poppins">
        <div className="flex flex-col items-center justify-center p-1 h-1/3">
          <div className="text-xs font-medium text-center text-tertiary hover:text-primary">
            {title}
          </div>
        </div>
