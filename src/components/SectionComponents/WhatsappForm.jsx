  ...
  return (
    <div className="text-paragraph3 phone3:text-paragraph4">
      ...
      <div className="mb-5">
        ...
        {errors.email && !errors.email.includes("@") && (
          <p className="-mt-2 -mb-1 text-xs text-red-500">
            Digite um e-mail válido. Inclua as expressões "@" e ".com".
          </p>
        )}
      ...
      <div className="flex justify-center">
        <button
          className="flex items-center w-full px-4 py-2 font-medium text-white transition rounded-lg text-title1 h-14 phone2:h-14 phone3:h-18 bg-primary hover:bg-secondary"
