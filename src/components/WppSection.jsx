...
export default function WppSection() {
  return (
    <div className="bg-red-100 mt-28 content" id="contact">
      <SectionContent>
        <div className="w-full h-48 bg-blue-300">
          <div className="flex flex-row items-end justify-between h-48 bg-blue-500 ">
            <div className="bg-grenn-200">
              <div className="flex flex-col justify-around h-48 bg-blue-700">
                <h1 className="text-3xl text-white bg-green-800 font-poppins">
